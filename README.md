...
[[GDC Converter]](https://github.com/Relintai/broken_seals/tree/master/game/addons/gdc_converter) - An addon which can be used to help with converting typed gdscript and scenes to c++ (with some manual intervention).\
